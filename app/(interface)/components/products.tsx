...
export const ProductCard = ({
  ...
  return (
    ...
    >
      <div className="flex flex-col relative h-full overflow-hidden transition-all duration-200 ease-in-out">
        ...
        <div>
          <div className="mt-4 mb-2 text-xl transition-colors group-hover:underline font-bold">
            {product.title}{" "}
          </div>
